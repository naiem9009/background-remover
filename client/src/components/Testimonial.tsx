...
import { ITestimonialsData } from "../types/type"
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto px-4 py-8">
        {testimonialsData && testimonialsData.map((testimonial:ITestimonialsData, index:number) => (
          <div className="bg-white rounded-xl-6 p-6 drop-shadow-md max-w-lg m-auto hover:scale-105 transition-all duration-700" key={index}>
